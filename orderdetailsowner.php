    ...
    <body class="homeshopper">
      ...
      <section>
        ...
        <div class="myorderwrap">
          <form class='uploadcontainer'  method='POST' action='statuspayment.php'>
          <?php
          $sql = "select * from orders JOIN customer ON customer.CustomerID = orders.CustomerID JOIN product ON product.ProductID = orders.ProductID where OrderID = $orderid;";
          ...
          if($result->num_rows > 0) {
            ...
            <div class='float-container'>
                ...
                <div class='float-child2'>
                    <h4 style='padding-top: 10px;' name='name'>".$row['Name']."</h4>
                    <h4 style='padding-top: 10px;' name='matricno'>".$row['MatricNo']."</h4>
                    <h4 style='padding-top: 10px;' name='phoneno'>".$row['PhoneNo']."</h4>
                    <h4 style='padding-top: 10px;' name='roomaddress'>".$row['Address']."</h4>
                </div>
            </div><br>
            ...
            <div class='float-container'>
                ...
                <div class='float-child1'>
                    ...
                    <h4 style='font-weight: bolder; padding-top: 10px;' name='pstatus'>Received Payment ?</h4>
                </div>
                <div class='float-child2'>
                    <h4 style='padding-top: 10px;' name='date'>".$row['OrderDate']."</h4>
                    <h4 style='padding-top: 10px;' name='ostatus'>".$row['OrderStatus']."</h4>
                    <h4 style='padding-top: 10px;' name='dmethod'>".$row['DeliveryMethod']."</h4>
                    <h4 style='padding-top: 10px;' name='pmethod'>".$row['PaymentMethod']."</h4>
                    ...
                    <h4 style='padding-top: 12px;' name='pstatus'>".$row['PaymentStatus']."</h4>
                    <select name='upstatus' id='pstatus' style='margin-top: 18px; font-size: 16px;'>
                        <option name='upstatus' value='Pending'>No</option>
                        <option name='upstatus' value='Completed'>Yes</option>
                    </select>
                </div>
            </div><br>
            ...
            <div class='btncenter'>
                <button type='submit' formaction='orderowner.php'>BACK</button>
                <button type='submit' formaction='statuspayment.php?OrderID=".$orderid."'>UPDATE</button>
            </div><br>";
          }
        }
        else {
